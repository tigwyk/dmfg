...
def create_trade_page():
	...
	if form.validate_on_submit():
		trade = Trade(quantity=form.quantity.data, price=form.price.data,created_date=datetime.now(),item=form.item.data,user=current_user,order_type=form.order_type.data)
